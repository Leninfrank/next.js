  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <LinkAccordion href="/dynamic-stale-5-minutes" prefetch={true}>
            Page whose dynamic prefetch has a stale time of 5 minutes
          </LinkAccordion>
        </li>
        <li>
          <LinkAccordion href="/dynamic-stale-10-minutes" prefetch={true}>
            Page whose dynamic prefetch has a stale time of 10 minutes
          </LinkAccordion>
        </li>
        <li>
