  ...
  return (
    <main>
      ...
      <p id="intro">
        ...
        also not be included in a dynamic prefetch, because it has a short
        enough stale time (&lt; DYNAMIC_PREFETCH_DYNAMIC_STALE, 30s)
      </p>
...
async function ShortLivedCache() {
  'use cache'
  unstable_cacheLife({
    stale: 20, // < DYNAMIC_PREFETCH_DYNAMIC_STALE
    revalidate: 2 * 60,
