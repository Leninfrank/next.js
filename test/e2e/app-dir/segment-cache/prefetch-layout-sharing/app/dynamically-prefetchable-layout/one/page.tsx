...
async function PrefetchableDynamic() {
  ...
  return (
    <div style={{ border: '1px solid blue', padding: '1em' }}>
      ...
      {/*
        TODO: a dynamically prefetched layout that had no holes itself will still be considered partial
        if any other segment in the response is partial, because we don't track partiality per-segment,
        so if we want to test that full prefetches can reuse layouts from dynamic prefetches,
